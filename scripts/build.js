const fs = require('fs');
const claudeContent = fs.readFileSync('knowledge/Claude code skill for AI slide templates.md', 'utf8');
const gemsContent = fs.readFileSync('knowledge/Gems Custom Instruction for AI slide templates.md', 'utf8');
